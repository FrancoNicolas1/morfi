          ...
          <div class="left box-primary">
            ...
            {userRestaurant && userRestaurant.length > 0 ? (
              ...
              <h3 class="username text-center">
                Usted por el momento no tiene restaurantes publicados
              </h3>
            )}
          </div>
            ...
            <form onSubmit={submitUserUpdate} class="form-horizontal">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  />
                  {error.surname && (
                    <label className="error">{error.surname}</label>
                  )}
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  />
                  {error.user_mail && (
                    <label className="error">{error.user_mail}</label>
                  )}
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  />
                  {error.phone && (
                    <label className="error">{error.phone}</label>
                  )}
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  {error.identification && (
                    <label className="error">{error.identification}</label>
                  )}
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  />
                  {error.postalCode && (
                    <label className="error">{error.postalCode}</label>
                  )}
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  />
                  {error.street_name && (
                    <label className="error">{error.street_name}</label>
                  )}
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  />
                  {error.street_number && (
                    <label className="error">{error.street_number}</label>
                  )}
                </div>
              </div>
